...
\addcontentsline{toc}{section}{Список литературы}
    ...
    \bibitem{twitter_streaming} https://dev.twitter.com/streaming/overview
    \bibitem{tweepy} ссылка на tweepy
    \bibitem{feedparser} feedparser
    \bibitem{shelve} shelve
    \bibitem{numpy} numpy
    \bibitem{openblass}  https://hunseblog.wordpress.com/2014/09/15/installing-numpy-and-openblas/
