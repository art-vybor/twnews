...
\section{Полезные ссылки}
    ...
    \begin{itemize}
        ...
        \item Диплом на тему <<Разработка сервиса извлечения мнений>>: http://miem.hse.ru/data/2013/06/03/1285534094/\%D0\%94\%D0\%B8\%D0\%BF\%D0\%BB\%D0\%BE\%D0\%BC\_\%D0\%9B\%D0\%B5\%D0\%B2\%D1\%87\%D0\%B8\%D0\%BA\_.pdf
